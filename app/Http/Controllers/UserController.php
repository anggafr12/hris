...
class UserController extends Controller
{
    ...
    public function editprofile(Request $request)
    {
        ...
        if ($request->hasFile('profile')) {
            ...
            if ($user->avatar && \Storage::disk('public')->exists('uploads/avatar/' . $user->avatar)) {
                \Storage::disk('public')->delete('uploads/avatar/' . $user->avatar);
            }

            // Simpan file ke public/uploads/
            $file->storeAs('uploads/avatar', $filename, 'public');
        ...
        // Update email untuk employee (jika user type employee)
